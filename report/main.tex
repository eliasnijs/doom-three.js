...
Our system calculates displacement vectors using the centers of bounding boxes
rather than object positions directly. This center-based direction calculation
provides more reliable and consistent collision responses, especially for
objects with offset centers or irregular shapes represented by AABBs.
